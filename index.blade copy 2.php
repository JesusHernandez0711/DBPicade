                                ...
                                <td>
                                    @php
                                        ...
                                        $badgeColor = match($user->Rol_Usuario) {
                                            ...
                                            'Instructor'    => 'bg-warning-subtle text-dark border-warning-subtle',
                                            'Coordinador'   => 'bg-primary-subtle text-primary border-primary-subtle',
                                            default         => 'bg-info-subtle text-primary border',
                                        };
                                    @endphp
                                    <span class="badge {{ $badgeColor }} border fw-bold rounded-pill px-3">
                                        {{ $user->Rol_Usuario }}
                                    </span>
                                </td>
