...
<head>
    ...
    {{-- ═══ ESTILOS ═══
         Glassmorphism y animaciones se cargan desde:
         resources/css/components/glassmorphism.css (importado en app.css via Vite)
    --}}
</head>
...
<body class="font-montserrat h-screen overflow-hidden m-0">
    ...
    <div class="fixed inset-0 z-0">
        {{-- Imagen de fondo --}}
        <img
            src="{{ asset('storage/images/Simulacro.webp') }}"            alt=""
            aria-hidden="true"
    ...
    {{-- Toggle de password se carga desde:
         resources/js/components/password-toggle.js (importado en app.js via Vite) --}}
</body>
</html>