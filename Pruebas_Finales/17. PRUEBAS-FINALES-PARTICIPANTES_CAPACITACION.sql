...
BEGIN
    ...
    -- =============================================
    -- 2. VARIABLES PARA NOMBRES Y EMAIL
    -- =============================================
    DECLARE v_ListaNombres JSON;
    DECLARE v_ListaApellidos JSON;
    
    DECLARE v_NombreRand VARCHAR(100);
    DECLARE v_PrimerNombre VARCHAR(100); -- Para extraer "MARIA" de "MARIA DEL CARMEN"
    DECLARE v_ApellidoRand VARCHAR(100);
    DECLARE v_ApellidoMaternoRand VARCHAR(100);
    DECLARE v_EmailGenerado VARCHAR(150);
    
    DECLARE v_TotalNombres INT;
    DECLARE v_TotalApellidos INT;
    
    -- =============================================
    -- 3. CARGA DE DATOS (LISTAS EXTENDIDAS A 50+)
    -- =============================================
    
    -- Lista extraída y limpiada de tu input
-- Mix de tus nombres anteriores + Nombres comunes en México
    SET v_ListaNombres = '[
        "NORMA ALICIA", "ENRIQUE", "GUSTAVO ADOLFO", "DANELLIA", "TERESA DE JESUS", "GUILLERMO", "OSCAR MANUEL", "JOSE JUAN", "FELIPE", "RENE", 
        "ALEJANDRO ERUBIEL", "LEOPOLDO ANTONIO", "EMILIA", "ALFREDO", "MARIA CONCEPCION", "MARIA DE LOS ANGELES", "ABEL ROGELIO", "KIKEY", "VICTOR MANUEL", "CARLOS", 
        "HECTOR ELIUD", "OSCAR JACINTO", "GREGORIO", "LUIS RAUL", "JORGE", "IRINEO", "TITO", "LUIS ANTONIO", "OCTAVIANA", "CARLOS ARMANDO", 
        "MARIA DEL CARMEN", "ANGEL", "CRISTIAN AMADIS", "JOSE EDUARDO", "ENRIQUE LINO", "JOSE MARIA", "GILBERTO", "MARIO ESTUARDO", "HUGO ALBERTO", "TATIANA", 
        "MARTIN GIL", "MARIA TERESA", "ROCIO", "HECTOR HUGO", "MARCOS AURELIO", "CARLOS ALBERTO", "CARLOS MARIO", "VERONICA", "MARTIN CUAUHTEMOC", "PABLO SAUL", 
        "ARCADIO VLADIMIR", "JUAN JOSE", "JORGE ALEJANDRO", "JORGE LUIS", "SOFIA", "SANTIAGO", "CAMILA", "SEBASTIAN", "VALENTINA", "MATEO",
        "ISABELLA", "NICOLAS", "LUCIA", "ALEJANDRO", "MARIANA", "DIEGO", "GABRIELA", "SAMUEL", "VICTORIA", "DANIEL",
        "MARTINA", "LEONARDO", "LUCIANA", "EDUARDO", "DANIELA", "ANDREA", "NATALIA", "JAVIER", "VALERIA", "LUIS",
        "FERNANDA", "ADRIAN", "XIMENA", "IKER", "REGINA", "EMILIANO", "RENATA", "MIGUEL ANGEL", "FRANCISCO JAVIER", "RICARDO",
        "LETICIA", "PATRICIA", "ROSA MARIA", "ADRIANA", "ELIZABETH", "ALMA ROSA", "YOLANDA", "MARTHA", "ALICIA", "BEATRIZ"
    ]';
    
    -- Lista ampliada de 50 Apellidos Mexicanos
-- Mix de tus apellidos anteriores + Apellidos comunes
    SET v_ListaApellidos = '[
        "GARCIA", "RODRIGUEZ", "MARTINEZ", "HERNANDEZ", "LOPEZ", "GONZALEZ", "PEREZ", "SANCHEZ", "RAMIREZ", "TORRES", 
        "FLORES", "RIVERA", "GOMEZ", "DIAZ", "REYES", "MORALES", "ORTIZ", "CASTILLO", "MORENO", "VARGAS", 
        "ROMERO", "MENDOZA", "RUIZ", "HERRERA", "MEDINA", "AGUILAR", "CASTRO", "JIMENEZ", "RAMOS", "VAZQUEZ", 
        "ALVAREZ", "CHAVEZ", "VELAZQUEZ", "ESPINOSA", "OCHOA", "AVILA", "CARRASCO", "DOMINGUEZ", "ESCOBAR", "FIGUEROA", 
        "GUZMAN", "IBARRA", "LARA", "LEON", "MIRANDA", "NAVARRO", "OROZCO", "PACHECO", "QUINTERO", "ROJAS", 
        "SALAZAR", "TAPIA", "VALENZUELA", "ZAMORA", "CRUZ", "GARZA", "SOTO", "DELGADO", "ESTRADA", "VEGA", 
        "GUERRERO", "SANDOVAL", "CARRILLO", "VALDEZ", "SALAS", "CONTRERAS", "MALDONADO", "DE LA CRUZ", "ESQUIVEL", "ALVARADO", 
        "PONCE", "MEJIA", "LUNA", "SOLIS", "NUÑEZ", "VILLANUEVA", "ARROYO", "CABRERA", "CAMPOS", "CERVANTES",
        "FUENTES", "MOLINA", "ROSALES", "SANTOS", "TREJO", "VALENCIA", "ZAVALA", "AGUIRRE", "BELTRAN", "CARDENAS",
        "CISNEROS", "CORONA", "DURAN", "ECHEVERRIA", "GALLEGOS", "HUERTA", "JARAMILLO", "LAGUNA", "MONTIEL", "OLIVARES"
    ]';
    ...
    -- =============================================
    -- 4. INICIO DEL BUCLE (GENERAR 50 USUARIOS)
    -- =============================================
    WHILE i <= 70 DO
        
        -- A) GENERACIÓN DE FECHAS
        ...
        SET v_ApellidoMaternoRand = JSON_UNQUOTE(JSON_EXTRACT(v_ListaApellidos, CONCAT('$[', FLOOR(RAND() * v_TotalApellidos), ']')));
        
        -- C) LÓGICA DE CORREO: NOMBRE.APELLIDO@PEMEX.COM
        -- Paso 1: Obtenemos solo la primera palabra del nombre (Ej: "MARIA" de "MARIA DE LOS ANGELES")
        -- Esto evita correos kilométricos o con espacios intermedios.
        SET v_PrimerNombre = SUBSTRING_INDEX(v_NombreRand, ' ', 1);
        
        -- Paso 2: Concatenamos con punto y apellido paterno
        SET v_EmailGenerado = CONCAT(v_PrimerNombre, '.', v_ApellidoRand,'.',v_ApellidoMaternoRand, '@PEMEX.COM');

        -- D) LLAMADA AL SP
        CALL SP_RegistrarUsuarioPorAdmin(
            @AdminEjecutor, 
            CONCAT('QA-DIAMOND-P', LPAD(i,2,'0')), 
            NULL, 
            v_NombreRand,           -- Nombre Completo (Ej: "MARIA DE LOS ANGELES")
            v_ApellidoRand,         -- Apellido Paterno (Ej: "HERNANDEZ")
            v_ApellidoMaternoRand,  -- Apellido Materno (Ej: "GARCIA")
            v_FecNac, 
            v_FecIng, 
            v_EmailGenerado,        -- Email limpio: MARIA.HERNANDEZ@PEMEX.COM
            '123', 
            @RolPart, 
            @IdRegimen, 
            @IdPuesto, 
