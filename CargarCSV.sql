...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\PAISES-FINAL.csv'
INTO TABLE `Pais`
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\ESTADOS-FINAL.csv'
INTO TABLE `Estado`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\MUNICIPIO-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-CENTROS-TRABAJO-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-DEPARTAMENTOS-TRABAJO-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-DIRECCIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-SUBDIRECCIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-GERENCIAS-ACTIVOS-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-REGIMENES-TRABAJO-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-REGIONES-FINAL.csv'
...
SET
	`Codigo`      = NULL, -- Dejamos el código vacio explícitamente
    `Nombre`      = TRIM(@Var_Nombre), -- Limpiamos espacios
    `Descripcion` = NULLIF(TRIM(@Var_Descripcion), ''),
    `Activo` = 1,
    `created_at` = NOW(),
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-PUESTOS-TRABAJO-FINAL.csv'
...
SET
	`Codigo` = NULL, -- NULLIF(TRIM(@Var_Codigo), ''), -- Dejamos el código vacio explícitamente
    `Nombre`      = TRIM(@Var_Nombre), -- Limpiamos espacios
    `Descripcion` = NULLIF(TRIM(@Var_Descripcion), ''),
    `Activo` = 1,
    `created_at` = NOW(),
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\INFO-PERSONAL-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-ROLES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\INFO-USUARIO-FINAL.csv'
INTO TABLE `Usuarios`
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-ESTATUS-CAPACITACIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-MODALIDAD-CAPACITACIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-CASES-SEDES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-TIPO-CAPACITACIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-CAPACITACIONES-FINAL.csv'
...
LOAD DATA INFILE 'C:\\Users\\Jesus_PC\\Desktop\\PICADE\\CVS-FINALES\\CATALOGO-ESTATUS-PARTICIPANTE-FINAL.CSV'
