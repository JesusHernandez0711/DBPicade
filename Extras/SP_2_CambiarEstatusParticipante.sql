    ...
    IF _Nuevo_Estatus = 0 THEN
        ...
        /* [CONSULTA FORENSE MULTI-NIVEL]:
           ...
           5. WHERE ...
              ...
              -> C.Activo = 1: La cabecera del curso no ha sido borrada.
              
              -> EC.Es_Final = 0: **EL CANDADO MAESTRO**. 
                 Solo nos importan los cursos OPERATIVOS (En Curso, Programados, etc.).
                 Si Es_Final=1 (Finalizado/Cancelado), NO bloqueamos porque ya es historia muerta.
        */
        ...
        IF v_Folio_Curso_Conflicto IS NOT NULL THEN
            ...
            SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_Mensaje_Final;
        END IF;
