/* ======================================================================================================
   ...
   DIFERENCIAS CRÍTICAS VS. INSCRIPCIÓN ADMINISTRATIVA:
   1. Autoría (Non-Repudiation): El registro de auditoría `Created_By` se marca con el ID del 
      propio usuario. Esto sirve como firma digital de consentimiento/interés.
   2. Rigor en Reglas: A diferencia del Admin, el usuario NO puede sobrepasar cupos manuales, 
      ni inscribirse fuera de fechas (si se implementaran), ni revivir cursos archivados.
   3. UX Feedback: Los mensajes de retorno están redactados en segunda persona ("Te has inscrito")
...
ProcAutoIns: BEGIN
    ...
    -- Almacenan el estado del usuario para determinar si tiene privilegios de operación.
    ...
    -- Almacenan la fotografía del curso en el momento exacto de la petición.
    ...
    -- Se definen aquí para evitar "números mágicos" dispersos en la lógica.
    ...
    SELECT 
        ...
        `DC`.`Fk_Id_CatEstCap`,               -- [3] Status ID
    ...
    -- [SUB-CONSULTA]: Obtener datos de la cabecera (Meta y Nombre)
    ...
    -- Verificamos si el estatus operativo (ej. "Finalizado", "Cancelado") prohíbe cambios.
